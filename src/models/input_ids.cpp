...
DefaultInputIDs::DefaultInputIDs(State& state)
  ...
  std::cout<<"sjafgbahgaogbau nou Name of input_ids = "<<name_<<std::endl;
  ...
  std::cout<<"Creating cast tensor"<<std::endl;
...
void DefaultInputIDs::Add() {
  ...
  std::cout<<"Shape of InputIDs = "<<shape_[0]<<" "<<shape_[1]<<std::endl;
...
void DefaultInputIDs::Update(DeviceSpan<int32_t> new_tokens) {
  ...
  // std::cout<<"Shapes match = "<<shape_[0]<<" "<<shape_[1]<<std::endl;
  ...
  if (is_prompt_ && state_.params_->search.num_beams > 1) {
    ...
    // std::cout<<"Shape_0 = "<<shape_[0]<<std::endl;
    // std::cout<<"Shape_1 = "<<shape_[1]<<std::endl;
