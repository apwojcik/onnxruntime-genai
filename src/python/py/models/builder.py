...
class BitNetModel(MistralModel):
    ...
    def make_mlp_proj(self, layer_id, mlp, root_input):
        ...
        self.make_external_tensor(mlp.ffn_sub_norm.weight.detach().numpy().astype(np.float32), ffn_sub_norm_weight_name)
    ...
    def make_attention(self, layer_id, attention, root_input, **kwargs):
        ...
        self.make_external_tensor(attention.attn_sub_norm.weight.detach().numpy().astype(np.float32), attn_sub_norm_weight_name)
